...
const INITIAL_USERS = [
    {
        id: 'u1',
        name: 'Owner Admin',
        role: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Role"].ADMIN,
        pin: '1111',
        permissions: [
            'POS',
            'INVENTORY',
    ...
    },
    {
        id: 'u2',
        name: 'Store Manager',
        role: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Role"].MANAGER,
        pin: '2222',
        permissions: [
            'POS',
            'INVENTORY',
    ...
    },
    {
        id: 'u3',
        name: 'Joe Cashier',
        role: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Role"].CASHIER,
        pin: '3333',
        permissions: [
            'POS'
        ]
...
const INITIAL_PRODUCTS = [
    {
        ...
        type: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlcoholType"].WHISKEY,
        size: '750ml',
        brand: 'Jameson',
        sku: '1001',
        costPrice: 2000,
    ...
    },
    {
        id: 'p3',
        name: 'Smirnoff Red',
        type: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlcoholType"].VODKA,
        size: '750ml',
        brand: 'Smirnoff',
        sku: '2001',
        costPrice: 1200,
    ...
    },
    {
        ...
        type: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlcoholType"].GIN,
        size: '750ml',
        brand: 'Tanqueray',
        sku: '3001',
        costPrice: 1850,
    ...
    },
    {
        ...
        type: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlcoholType"].BEER,
        size: '330ml x6',
        brand: 'Corona',
        sku: '4001',
        costPrice: 800,
...
"[project]/cloud.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(SUPABASE_URL, SUPABASE_KEY);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/db.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$cloud$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/cloud.ts [app-client] (ecmascript)");
;
...
const StoreProvider = ({ children })=>{
    ...
    const [businessSettings, setBusinessSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // ------------------------------------------------------------------
    // 1. INITIALIZATION
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoreProvider.useEffect": ()=>{
            const loadData = {
                "StoreProvider.useEffect.loadData": async ()=>{
                    try {
                        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dbPromise"])();
                        ...
                        if (navigator.onLine) {
                            try {
                                // 1. Users
                                const { data: cloudUsers } = await __TURBOPACK__imported__module__$5b$project$5d2f$cloud$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*');
                                if (cloudUsers && cloudUsers.length > 0) {
                                    for (const u of cloudUsers)await db.put('users', u);
                                    loadedUsers = cloudUsers;
                                }
                                // 2. Products
                                const { data: cloudProducts } = await __TURBOPACK__imported__module__$5b$project$5d2f$cloud$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('products').select('*');
                                ...
                                const { data: cloudSales } = await __TURBOPACK__imported__module__$5b$project$5d2f$cloud$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sales').select('*');
                                if (cloudSales && cloudSales.length > 0) {
                                    // Merge: Cloud sales take precedence, but keep local-only sales
                                    const cloudSaleIds = new Set(cloudSales.map({
                                        "StoreProvider.useEffect.loadData": (s)=>s.id
                                    }["StoreProvider.useEffect.loadData"]));
                                    const localOnlySales = loadedSales.filter({
                                        "StoreProvider.useEffect.loadData.localOnlySales": (s)=>!cloudSaleIds.has(s.id)
                                    }["StoreProvider.useEffect.loadData.localOnlySales"]);
                                    const mergedSales = [
                                        ...cloudSales,
                                        ...localOnlySales
                                    ];
                                ...
                                const { data: cloudShifts } = await __TURBOPACK__imported__module__$5b$project$5d2f$cloud$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('shifts').select('*');
                                if (cloudShifts && cloudShifts.length > 0) {
                                    const cloudShiftIds = new Set(cloudShifts.map({
                                        "StoreProvider.useEffect.loadData": (s)=>s.id
                                    }["StoreProvider.useEffect.loadData"]));
                                    const localOnlyShifts = loadedShifts.filter({
                                        "StoreProvider.useEffect.loadData.localOnlyShifts": (s)=>!cloudShiftIds.has(s.id)
                                    }["StoreProvider.useEffect.loadData.localOnlyShifts"]);
                                    const mergedShifts = [
                                        ...cloudShifts,
                                        ...localOnlyShifts
                                    ];
                        ...
                        if (loadedUsers.length === 0) {
                            ...
                            const seedUsers = legacyUsers ? JSON.parse(legacyUsers) : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INITIAL_USERS"];
                            // Normalize permissions to ensure data integrity
                            const finalSeedUsers = seedUsers.map({
                                "StoreProvider.useEffect.loadData.finalSeedUsers": (u)=>{
                                    if (!u.permissions) {
                                        if (u.role === __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Role"].ADMIN) return {
                                            ...u,
                                            permissions: [
                                                'POS',
                                                'INVENTORY',
                                        ...
                                        if (u.role === __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Role"].MANAGER) return {
                                            ...u,
                                            permissions: [
                                                'POS',
                                                'INVENTORY',
                            ...
                            }["StoreProvider.useEffect.loadData.finalSeedUsers"]);
                            // Save seeds to DB
                        ...
                        if (loadedProducts.length === 0) {
                            ...
                            const seedProducts = legacyProducts ? JSON.parse(legacyProducts) : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INITIAL_PRODUCTS"];
                            for (const p of seedProducts)await db.put('products', p);
                            loadedProducts = seedProducts;
                        }
                        // Sort Data (Newest first for logs/sales)
                        loadedSales.sort({
                            "StoreProvider.useEffect.loadData": (a, b)=>new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime()
                        }["StoreProvider.useEffect.loadData"]);
                        loadedLogs.sort({
                            "StoreProvider.useEffect.loadData": (a, b)=>new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime()
                        }["StoreProvider.useEffect.loadData"]);
            ...
            const handleOnline = {
                "StoreProvider.useEffect.handleOnline": ()=>setIsOnline(true)
            }["StoreProvider.useEffect.handleOnline"];
            const handleOffline = {
                "StoreProvider.useEffect.handleOffline": ()=>setIsOnline(false)
            }["StoreProvider.useEffect.handleOffline"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoreProvider.useEffect": ()=>{
            ...
            const MAX_RETRIES = 5;
            const syncData = {
                "StoreProvider.useEffect.syncData": async ()=>{
                    ...
                    if (keys.length > 0) {
                        ...
                        for(let i = 0; i < keys.length; i++){
                            ...
                            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$cloud$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pushToCloud"])(job.type, job.payload);
                            if (success) {
   ...
   */ const addLog = async (action, details)=>{
        ...
        // Queue for Cloud
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('LOG', newLog);
    };
    const login = (pin)=>{
   ...
   */ const updateUser = async (updatedUser)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('UPDATE_USER', updatedUser);
    };
    const addUser = async (userData)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('ADD_USER', newUser);
    };
    const deleteUser = async (userId)=>{
        ...
        if (user) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('DELETE_USER', {
                id: userId
            });
        }
    };
   ...
   */ const openShift = async (openingCash = 0)=>{
        ...
        const details = openingCash > 0 ? `Shift opened with ${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CURRENCY_FORMATTER"].format(openingCash)}` : `Shift opened (No Float)`;
        await addLog('SHIFT_OPEN', details);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('OPEN_SHIFT', newShift);
    };
    const closeShift = async (closingCash)=>{
        ...
        await addLog('SHIFT_CLOSE', `Shift closed. Counted: ${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CURRENCY_FORMATTER"].format(closingCash)}, Expected: ${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CURRENCY_FORMATTER"].format(expected)}`);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('CLOSE_SHIFT', updatedShift);
    };
    /**
   * PROCESS SALE
   ...
   */ const processSale = async (items, paymentMethod)=>{
        ...
        // Commit transaction
        await tx.done;
        await addLog('SALE', `Sale #${newSale.id} processed for ${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CURRENCY_FORMATTER"].format(totalAmount)} via ${paymentMethod}`);
        return newSale;
    };
    /**
   ...
   */ const addProduct = async (productData)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('ADD_PRODUCT', newProduct);
    };
    const updateProduct = async (product)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('UPDATE_PRODUCT', product);
    };
    const adjustStock = async (productId, change, reason)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('ADJUST_STOCK', updatedProduct); // Send full product object to simple overwrite
    };
    const receiveStock = async (productId, quantity, newCost)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('RECEIVE_STOCK', updatedProduct);
    };
    /**
   * Business Settings
   */ const updateBusinessSettings = async (settings)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToSyncQueue"])('UPDATE_SETTINGS', settings);
    };
    if (isLoading) {
...
_s(StoreProvider, "LB9GCRTmxKaF4uKTWSmq3hAtoFw=");
_c = StoreProvider;
const useStore = ()=>{
    _s1();
...
//# sourceMappingURL=_954e78dd._.js.map