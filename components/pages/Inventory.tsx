  ...
  return (
    <div className="p-3 lg:p-6 max-w-7xl mx-auto">
      <div className="mb-4 lg:mb-6 flex justify-between items-center">
        ...
        <span className="text-xs text-slate-500">Active: {activeTab}</span>
      </div>
      ...
      >
        <TabsList className="w-full justify-start overflow-x-auto">
          <TabsTrigger value="VIEW" className="flex gap-2">
            <AlertCircle size={16} /> Stock Levels
          </TabsTrigger>
          <TabsTrigger value="RECEIVE" className="flex gap-2">
            <ArrowDown size={16} /> Receive Stock
          </TabsTrigger>
          <TabsTrigger value="ADJUST" className="flex gap-2">
            <ArrowUp size={16} /> Adjustments
          </TabsTrigger>
        ...
        <TabsContent value="RECEIVE">
          <div className="max-w-xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-4 lg:p-8">
            <h2 className="text-lg lg:text-xl font-bold mb-4 lg:mb-6">Receive New Shipment</h2>
            <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Quantity Received</label>
                <input type="number" className="w-full p-2.5 lg:p-3 border rounded-lg focus:ring-2 focus:ring-amber-500 outline-none text-sm lg:text-base" placeholder="12" value={quantity} onChange={e => setQuantity(e.target.value)} required />
              </div>
        ...
        <TabsContent value="ADJUST">
          <div className="max-w-xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-4 lg:p-8">
            <h2 className="text-lg lg:text-xl font-bold mb-4 lg:mb-6">Correct Stock Level</h2>
            <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Select Product</label>
                <select className="w-full p-2.5 lg:p-3 border rounded-lg bg-slate-50 focus:ring-2 focus:ring-amber-500 outline-none text-sm lg:text-base" value={selectedProductId} onChange={e => setSelectedProductId(e.target.value)} required>
              ...
              <div>
                ...
                <input type="number" className="w-full p-2.5 lg:p-3 border rounded-lg focus:ring-2 focus:ring-amber-500 outline-none text-sm lg:text-base" placeholder="e.g. -1 for breakage" value={quantity} onChange={e => setQuantity(e.target.value)} required />
                <p className="text-xs text-slate-500 mt-1">Use negative numbers to remove stock.</p>
              </div>
