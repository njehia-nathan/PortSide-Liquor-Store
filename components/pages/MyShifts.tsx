...
import { Clock, Calendar, DollarSign, ShoppingBag, X, Eye, FileText, Printer, Download } from 'lucide-react';
    ...
    <div className="p-3 lg:p-6 max-w-5xl mx-auto space-y-4 lg:space-y-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
          ...
          <p className="text-2xl font-bold text-slate-800">{myShifts.length}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-2 text-slate-500 mb-1">
            <ShoppingBag size={16} />
          ...
          <p className="text-2xl font-bold text-slate-800">{totalMySales}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-2 text-slate-500 mb-1">
            <DollarSign size={16} />
            ...
            <div className="p-4 lg:p-6 border-b border-slate-200 flex justify-between items-start">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-2 hover:bg-slate-100 rounded-lg text-green-600 hover:text-green-800"
                  title="Export to Excel"
                >
                  <Download size={20} />
                </button>
                <button type="button" onClick={() => setSelectedShift(null)} className="p-2 hover:bg-slate-100 rounded-lg">
