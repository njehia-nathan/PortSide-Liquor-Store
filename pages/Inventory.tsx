                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {editingAlertId === p.id ? (
                          <div className="flex items-center gap-1">
                            ...
                            <button onClick={() => setEditingAlertId(null)} className="text-slate-400 p-1"><XIcon size={16} /></button>
                          </div>
                        ) : (
                          <button 
                            onClick={() => startEditAlert(p)}
                            className="font-mono bg-slate-100 px-2 py-0.5 rounded text-xs flex items-center gap-1"
                          >
        ...
        <div className="max-w-xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-4 lg:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
                <div>
                    ...
                    <select 
                        className="w-full p-2.5 lg:p-3 border rounded-lg bg-slate-50 focus:ring-2 focus:ring-amber-500 outline-none text-sm lg:text-base"
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">
                        {activeTab === 'RECEIVE' ? 'Quantity Received' : 'Quantity Change (+/-)'}
                    </label>
                    <input 
                        type="number" 
                        className="w-full p-2.5 lg:p-3 border rounded-lg focus:ring-2 focus:ring-amber-500 outline-none text-sm lg:text-base"
                ...
                <button 
                    type="submit" 
                    className="w-full bg-slate-900 text-white py-3 lg:py-4 rounded-lg font-bold hover:bg-slate-800 flex items-center justify-center gap-2 text-sm lg:text-base"
                >
                    <Save size={18} />
                    Confirm Update
                </button>
