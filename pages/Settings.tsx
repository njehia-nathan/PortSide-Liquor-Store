    ...
    <div className="p-3 lg:p-6 max-w-3xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl lg:text-2xl font-bold text-slate-800 flex items-center gap-2">
          <SettingsIcon size={24} /> Business Settings
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                ...
                placeholder="Port Side Liquor Store"
            ...
            <div>
              ...
              <input 
                type="text"
                className="w-full border border-slate-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-amber-500 outline-none"
                placeholder="Your favorite neighborhood liquor store"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input 
                type="email"
                className="w-full border border-slate-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-amber-500 outline-none"
                placeholder="hello@portside.co.ke"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 lg:p-6">
          <h2 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
            <FileText size={18} /> Receipt Customization
          </h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                type="url"
                className="w-full border border-slate-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-amber-500 outline-none"
                placeholder="https://example.com/logo.png or /icons/icon-192x192.png"
                value={formData.logoUrl}
                onChange={(e) => handleChange('logoUrl', e.target.value)}
              />
              <p className="text-xs text-slate-500 mt-1">Use /icons/icon-192x192.png for the app icon</p>
            </div>
            
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">Receipt Footer Message</label>
              <textarea 
                className="w-full border border-slate-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-amber-500 outline-none"
        ...
        <div className="bg-slate-50 rounded-xl border border-slate-200 p-4 lg:p-6">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-slate-100 max-w-xs mx-auto text-center">
            {formData.logoUrl ? (
              <img src={formData.logoUrl} alt="Logo" className="w-16 h-16 mx-auto mb-2 object-contain" />
            ) : (
              <div className="w-16 h-16 bg-slate-200 rounded-full mx-auto mb-2 flex items-center justify-center text-slate-400">
                <Image size={24} />
              </div>
            )}
        ...
        <button 
          type="submit"
          className="w-full bg-amber-500 hover:bg-amber-600 text-white py-3 lg:py-4 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 transition-all active:scale-95"
        >
          <Save size={20} />
          Save Settings
        </button>
        ...
        {saved && (
          <div className="bg-green-100 text-green-800 px-4 py-3 rounded-lg text-center font-medium text-sm">
